# Hackerrank Challenges / Random Questions I came across
...
# Came across this problem the code is given but the question is what will be the output 
# its easy right obviously it will be [] [] [] but the default list continue to grow internally
# [1]
# []
# [1, 2]
# []
