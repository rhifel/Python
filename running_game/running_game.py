...
class Obstacle(pygame.sprite.Sprite):
    def __init__(self, type):
        ...
        if type == 'fly':
            fly_img_1 = pygame.image.load("graphics/Fly/Fly1.png").convert_alpha()
            fly_img_2 = pygame.image.load("graphics/Fly/Fly2.png").convert_alpha()
            self.frames = [fly_img_1, fly_img_2]
            y_pos = 210
            
        else:
            snail_img_1 = pygame.image.load("graphics/snail/snail1.png").convert_alpha()
            snail_img_2 = pygame.image.load("graphics/snail/snail2.png").convert_alpha()
